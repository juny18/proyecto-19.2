...
fantasmaCollided=loadAnimation("fantasma.png");
...
ghost.addAnimation("fantasma", fantasmaCollided);  
ghost.scale=0.3;
  ...
  if(gameState === PLAY){
   ...
   if(doorsGroup.isTouching(ghost)){
     ...
     //change the trex animation
      ghost.changeAnimation("fantasma", fantasmaCollided);
